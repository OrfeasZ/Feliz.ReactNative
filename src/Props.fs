...
type prop =
    ...
    // View props
    static member inline accessibilityActions(value: AccessibilityActions[]) =
        Interop.mkAttr "accessibilityActions" value

    /// Only on iOS.
    static member inline accessibilityElementsHidden(value: bool) =
        Interop.mkAttr "accessibilityElementsHidden" value

    static member inline accessibilityHint(value: string) =
        Interop.mkAttr "accessibilityHint" value

    static member inline accessibilityLabel(value: string) =
        Interop.mkAttr "accessibilityLabel" value

    /// Only on iOS.
    static member inline accessibilityLanguage(value: string) =
        Interop.mkAttr "accessibilityLanguage" value

    /// Only on iOS.
    static member inline accessibilityIgnoresInvertColors(value: bool) =
        Interop.mkAttr "accessibilityIgnoresInvertColors" value

    static member inline accessibilityState
        (value:
    ...
    static member inline accessibilityValue
        (value:
            {| min: float
               max: float
               now: float
               text: string |})
        =
        Interop.mkAttr "accessibilityValue" value

    /// Only on iOS.
    static member inline accessibilityViewIsModal(value: bool) =
        Interop.mkAttr "accessibilityViewIsModal" value
    ...
    static member inline hitSlop(value: seq<IRect>) =
        Interop.mkAttr "hitSlop" (createObj !!value)
    ...
    static member inline needsOffscreenAlphaCompositing(value: bool) =
        Interop.mkAttr "needsOffscreenAlphaCompositing" value
    ...
    static member inline onAccessibilityActions(value: AccessibilityActions -> unit) =
        Interop.mkAttr "onAccessibilityActions" value

    /// Only on iOS.
    static member inline onAccessibilityEscape(value: unit -> unit) =
        Interop.mkAttr "onAccessibilityEscape" value

    static member inline onAccessibilityTap(value: unit -> unit) =
        Interop.mkAttr "onAccessibilityTap" value
    ...
    static member inline onMoveShouldSetResponder(value: {| nativeEvent: PressEvent |} -> bool) =
        Interop.mkAttr "onMoveShouldSetResponder" value

    static member inline onMoveShouldSetResponderCapture(value: {| nativeEvent: PressEvent |} -> bool) =
        Interop.mkAttr "onMoveShouldSetResponderCapture" value

    static member inline onResponderGrant(value: {| nativeEvent: PressEvent |} -> unit) =
        Interop.mkAttr "onResponderGrant" value

    static member inline onResponderMove(value: {| nativeEvent: PressEvent |} -> unit) =
        Interop.mkAttr "onResponderMove" value

    static member inline onResponderReject(value: {| nativeEvent: PressEvent |} -> unit) =
        Interop.mkAttr "onResponderReject" value

    static member inline onResponderRelease(value: {| nativeEvent: PressEvent |} -> unit) =
        Interop.mkAttr "onResponderRelease" value

    static member inline onResponderTerminate(value: {| nativeEvent: PressEvent |} -> unit) =
        Interop.mkAttr "onResponderTerminate" value

    static member inline onResponderTerminationRequest(value: {| nativeEvent: PressEvent |} -> bool) =
        Interop.mkAttr "onResponderTerminationRequest" value

    static member inline onStartShouldSetResponder(value: {| nativeEvent: PressEvent |} -> bool) =
        Interop.mkAttr "onStartShouldSetResponder" value

    static member inline onStartShouldSetResponderCapture(value: {| nativeEvent: PressEvent |} -> bool) =
        Interop.mkAttr "onStartShouldSetResponderCapture" value

    static member inline removeClippedSubviews(value: bool) =
        Interop.mkAttr "removeClippedSubviews" value

    /// Only on Android.
    static member inline renderToHardwareTextureAndroid(value: bool) =
        Interop.mkAttr "renderToHardwareTextureAndroid " value

    /// Only on iOS.
    static member inline shouldRasterizeIOS(value: bool) =
        Interop.mkAttr "shouldRasterizeIOS " value

    static member inline style(properties: seq<IStyleAttribute>) =
        Interop.mkAttr "style" (createObj !!properties)

    static member inline testID(value: string) = Interop.mkAttr "testID" value

    // Text props
    static member inline adjustsFontSizeToFit(value: bool) =
        Interop.mkAttr "adjustsFontSizeToFit" value
    ...
    static member inline maxFontSizeMultiplier(value: float) =
        Interop.mkAttr "maxFontSizeMultiplier" value

    static member inline maxFontSizeMultiplier(value: obj) =
        Interop.mkAttr "maxFontSizeMultiplier" value
    ...
    static member inline onPressIn(value: {| nativeEvent: PressEvent |} -> unit) = Interop.mkAttr "onPressIn" value
    static member inline onPressOut(value: {| nativeEvent: PressEvent |} -> unit) = Interop.mkAttr "onPressOut" value
    static member inline onTextLayout(value: TextLayoutEvent -> 'a) = Interop.mkAttr "onTextLayout" value

    static member inline pressRetentionOffset(value: seq<IRect>) =
        Interop.mkAttr "pressRetentionOffset" (createObj !!value)

    static member inline pressRetentionOffset(value: float) =
        Interop.mkAttr "pressRetentionOffset" value
    ...
    /// Only on iOS.
    static member inline suppressHighlighting(value: string) =
        Interop.mkAttr "suppressHighlighting" value
    ...
    /// Only on iOS.
    static member inline capInsets(value: seq<IRect>) =
        Interop.mkAttr "capInsets" (createObj !!value)

    static member inline defaultSource(value: IImageSource) = Interop.mkAttr "defaultSource" value

    static member inline defaultSource(value: seq<IImageSourceProp>) =
        Interop.mkAttr "defaultSource" (createObj !!value)

    /// Only on Android.
    static member inline fadeDuration(value: float) = Interop.mkAttr "fadeDuration" value

    static member inline loadingIndicatorSource(uri: string) =
        Interop.mkAttr "loadingIndicatorSource" (createObj [ "uri" ==> uri ])
    ...
    static member inline onProgress(value: {| nativeEvent: {| loaded: float; total: float |} |} -> unit) =
        Interop.mkAttr "onProgress" value

    /// Only on Android.
    static member inline progressiveRenderingEnabled(value: bool) =
        Interop.mkAttr "progressiveRenderingEnabled" value

    static member inline source(value: IImageSource) = Interop.mkAttr "source" value

    static member inline source(value: seq<IImageSourceProp>) =
        Interop.mkAttr "source" (createObj !!value)
    ...
    static member inline contextMenuHidden(value: bool) =
        Interop.mkAttr "contextMenuHidden" value

    static member inline defaultValue(value: string) = Interop.mkAttr "defaultValue" value

    /// Only on Android.
    static member inline disableFullscreenUI(value: bool) =
        Interop.mkAttr "disableFullscreenUI" value

    static member inline editable(value: bool) = Interop.mkAttr "editable" value

    /// Only on iOS.
    static member inline enableReturnKeyAutomatically(value: bool) =
        Interop.mkAttr "enableReturnKeyAutomatically" value

    /// Only on Android.
    static member inline inlineImageLeft(value: string) = Interop.mkAttr "inlineImageLeft" value

    /// Only on Android.
    static member inline inlineImagePadding(value: string) =
        Interop.mkAttr "inlineImagePadding" value

    /// Only on iOS.
    static member inline inputAccessoryViewID(value: string) =
        Interop.mkAttr "inputAccessoryViewID" value
    ...
    static member inline onChange
        (value:
            {| nativeEvent:
                ...
                -> unit)
        =
        Interop.mkAttr "onChange" value

    static member inline onChangeText(value: string -> unit) = Interop.mkAttr "onChangeText" value

    static member inline onContentSizeChange
        (value: {| nativeEvent: {| contentSize: {| width: float; height: float |} |} |} -> unit)
        =
        Interop.mkAttr "onContentSizeChange" value
    ...
    static member inline onKeyPress(value: {| nativeEvent: {| key: string |} |} -> unit) =
        Interop.mkAttr "onKeyPress" value
                ...
                {| contentOffset: {| x: float; y: float |}
                   contentInset:
                       {| bottom: float
                          ...
                          right: float
                          top: float |}
                   contentSize: {| height: float; width: float |} |} |}
                -> unit)
        =
        Interop.mkAttr "onScroll" value

    static member inline onSelectionChange
        (value: {| nativeEvent: {| selection: {| start: int; ``end``: int |} |} |} -> unit)
        =
        Interop.mkAttr "onSelectionChange" value

    static member inline onSubmitEditing
        (value:
            {| nativeEvent:
                {| eventCount: int
                   target: int
                ...
                -> unit)
        =
        Interop.mkAttr "onSubmitEditing" value

    static member inline placeholder(value: string) = Interop.mkAttr "placeholder" value

    static member inline placeholderTextColor(value: string) =
        Interop.mkAttr "placeholderTextColor" value

    /// Only on Android.
    static member inline returnKeyLabel(value: string) = Interop.mkAttr "returnKeyLabel" value

    /// Only on iOS.
    static member inline rejectResponderTermination(value: bool) =
        Interop.mkAttr "rejectResponderTermination" value
    ...
    static member inline selectTextOnFocus(value: bool) =
        Interop.mkAttr "selectTextOnFocus" value

    static member inline showSoftInputOnFocus(value: bool) =
        Interop.mkAttr "showSoftInputOnFocus" value
    ...
    /// Only on Android.
    static member inline underlineColorAndroid(value: string) =
        Interop.mkAttr "underlineColorAndroid" value

    static member inline value(value: string) = Interop.mkAttr "value" value

    // ScrollView
    static member inline stickyHeaderComponent(value: seq<ReactElement>) =
        Interop.mkAttr "StickyHeaderComponent" value

    static member inline stickyHeaderComponent(value: ReactElement) =
        Interop.mkAttr "StickyHeaderComponent" value

    /// Only on iOS.
    static member inline alwaysBounceHorizontal(value: bool) =
        Interop.mkAttr "alwaysBounceHorizontal" value

    /// Only on iOS.
    static member inline alwaysBounceVertical(value: bool) =
        Interop.mkAttr "alwaysBounceVertical" value

    /// Only on iOS.
    static member inline automaticallyAdjustContentInsets(value: bool) =
        Interop.mkAttr "automaticallyAdjustContentInsets" value

    /// Only on iOS.
    static member inline automaticallyAdjustsScrollIndicatorInsets(value: bool) =
        Interop.mkAttr "automaticallyAdjustsScrollIndicatorInsets" value
    ...
    /// Only on iOS.
    static member inline canCancelContentTouches(value: bool) =
        Interop.mkAttr "canCancelContentTouches" value

    /// Only on iOS.
    static member inline centerContent(value: bool) = Interop.mkAttr "centerContent" value

    static member inline contentContainerStyle(value: seq<IStyleAttribute>) =
        Interop.mkAttr "contentContainerStyle" value

    /// Only on iOS.
    static member inline contentInset(top: float, bottom: float, left: float, right: float) =
        Interop.mkAttr
            "contentInset"
            {| top = top
               bottom = bottom
    ...
    static member inline directionalLockEnabled(value: bool) =
        Interop.mkAttr "directionalLockEnabled" value

    static member inline disableIntervalMomentum(value: bool) =
        Interop.mkAttr "disableIntervalMomentum" value

    static member inline disableScrollViewPanResponder(value: bool) =
        Interop.mkAttr "disableScrollViewPanResponder" value
    ...
    static member inline invertStickyHeaders(value: bool) =
        Interop.mkAttr "invertStickyHeaders" value

    static member inline maintainVisibleContentPosition
        (value:
            {| minIndexForVisible: float
               autoscrollToTopThreshold: float |})
        =
        Interop.mkAttr "maintainVisibleContentPosition" value
    ...
    /// Only on Android.
    static member inline nestedScrollEnabled(value: bool) =
        Interop.mkAttr "nestedScrollEnabled" value

    static member inline onContentSizeChange(value: (float * float) -> unit) =
        Interop.mkAttr "onContentSizeChange" value

    static member inline onMomentumScrollBegin(value: unit -> unit) =
        Interop.mkAttr "onMomentumScrollBegin" value

    static member inline onMomentumScrollEnd(value: unit -> unit) =
        Interop.mkAttr "onMomentumScrollEnd" value

    static member inline onScrollBeginDrag(value: unit -> unit) =
        Interop.mkAttr "onScrollBeginDrag" value
    ...
    /// Only on Android.
    static member inline persistentScrollbar(value: bool) =
        Interop.mkAttr "persistentScrollbar" value

    /// Only on iOS.
    static member inline pinchGestureEnabled(value: bool) =
        Interop.mkAttr "pinchGestureEnabled" value

    static member inline refreshControl(value: ReactElement) = Interop.mkAttr "refreshControl" value

    /// Only on iOS.
    static member inline scrollEventThrottle(value: float) =
        Interop.mkAttr "scrollEventThrottle" value

    /// Only on iOS.
    static member inline scrollIndicatorInsets(top: float, bottom: float, left: float, right: float) =
        Interop.mkAttr
    ...
    /// Only on iOS.
    static member inline scrollToOverflowEnabled(value: bool) =
        Interop.mkAttr "scrollToOverflowEnabled" value

    /// Only on iOS.
    static member inline scrollsToTop(value: bool) = Interop.mkAttr "scrollsToTop" value

    static member inline showsHorizontalScrollIndicator(value: bool) =
        Interop.mkAttr "showsHorizontalScrollIndicator" value

    static member inline showsVerticalScrollIndicator(value: bool) =
        Interop.mkAttr "showsVerticalScrollIndicator" value
    ...
    static member inline stickyHeaderHiddenOnScroll(value: bool) =
        Interop.mkAttr "snapToStartstickyHeaderHiddenOnScroll" value

    static member inline stickyHeaderIndices(value: seq<float>) =
        Interop.mkAttr "stickyHeaderIndices" value
    ...
    static member inline ListEmptyComponent(value: ReactElement) =
        Interop.mkAttr "ListEmptyComponent" value

    static member inline ListFooterComponent(value: ReactElement) =
        Interop.mkAttr "ListFooterComponent" value

    static member inline ListFooterComponentStyle(value: seq<IStyleAttribute>) =
        Interop.mkAttr "ListFooterComponentStyle" value

    static member inline ListHeaderComponent(value: ReactElement) =
        Interop.mkAttr "ListHeaderComponent" value

    static member inline ListHeaderComponentStyle(value: seq<IStyleAttribute>) =
        Interop.mkAttr "ListHeaderComponentStyle" value

    static member inline columnWrapperStyle(value: seq<IStyleAttribute>) =
        Interop.mkAttr "columnWrapperStyle" value

    static member inline extraData(value: _) = Interop.mkAttr "extraData" value

    static member inline getItemLayout
        (value:
            (obj * int)
                -> {| length: int
                      offset: int
                      index: int |})
        =
        Interop.mkAttr "getItemLayout" value

    static member inline initialNumToRender(value: int) =
        Interop.mkAttr "initialNumToRender" value

    static member inline initialScrollIndex(value: float) =
        Interop.mkAttr "initialScrollIndex" value
    ...
    static member inline onEndReached(value: {| info: {| distanceFromEnd: int |} |} -> unit) =
        Interop.mkAttr "onEndReached" value

    static member inline onEndReachedThreshold(value: float) =
        Interop.mkAttr "onEndReachedThreshold" value

    static member inline onRefresh(value: unit -> unit) = Interop.mkAttr "onRefresh" value

    static member inline onViewableItemsChanged
        (value:
            {| callback:
                {| changed: ViewToken[]
                ...
                -> unit)
        =
        Interop.mkAttr "onViewableItemsChanged" value

    static member inline progressViewOffset(value: float) =
        Interop.mkAttr "progressViewOffset" value

    static member inline refreshing(value: bool) = Interop.mkAttr "refreshing" value

    static member inline viewabilityConfig(value: seq<IViewabilityConfig>) =
        Interop.mkAttr "viewabilityConfig" (createObj !!value)
    ...
    /// Only on iOS.
    static member inline networkActivityIndicatorVisible(value: bool) =
        Interop.mkAttr "networkActivityIndicatorVisible" value

    static member inline translucent(value: bool) = Interop.mkAttr "translucent" value

    // Pressable
    /// Only on Android.
    static member inline androidDisableSound(value: bool) =
        Interop.mkAttr "android_disableSound" value

    /// Only on Android.
    static member inline androidRipple(value: seq<IRippleConfig>) =
        Interop.mkAttr "android_ripple" (createObj !!value)

    static member inline unstablePressDelay(value: float) =
        Interop.mkAttr "unstable_pressDelay" value
...
module prop =
    ...
    type autoComplete =
        ...
        static member inline postalAddressCountry =
            Interop.mkAttr "autoComplete" "postal-address-country"

        static member inline postalAddressExtended =
            Interop.mkAttr "autoComplete" "postal-address-extended"

        static member inline postalAddressExtendedPostalCode =
            Interop.mkAttr "autoComplete" "postal-address-extended-postal-code"

        static member inline postalAddressLocality =
            Interop.mkAttr "autoComplete" "postal-address-locality"

        static member inline postalAddressRegion =
            Interop.mkAttr "autoComplete" "postal-address-region"
    ...
    type contentInsetAdjustmentBehavior =
        ...
        /// Only on iOS.
        static member inline scrollableAxes =
            Interop.mkAttr "contentInsetAdjustmentBehavior" "scrollableAxes"
    ...
    type importantForAccessibility =
        ...
        static member inline noHideDescendants =
            Interop.mkAttr "importantForAccessibility" "no-hide-descendants"
    ...
    type importantForAutofill =
        ...
        static member inline noExcludeDescendants =
            Interop.mkAttr "importantForAutofill" "noExcludeDescendants"

        static member inline yes = Interop.mkAttr "importantForAutofill" "yes"

        static member inline yesExcludeDescendants =
            Interop.mkAttr "importantForAutofill" "yesExcludeDescendants"
    ...
    type keyboardType =
        ...
        /// Only on iOS.
        static member inline numbersAndPunctuation =
            Interop.mkAttr "keyboardType" "numbers-and-punctuation"
    ...
    type textContentType =
        ...
        /// Only on iOS.
        static member inline addressCityAndState =
            Interop.mkAttr "textContentType" "addressCityAndState"
        ...
        /// Only on iOS.
        static member inline streetAddressLine1 =
            Interop.mkAttr "textContentType" "streetAddressLine1"

        /// Only on iOS.
        static member inline streetAddressLine2 =
            Interop.mkAttr "textContentType" "streetAddressLine2"
